...
use app\models\UsuarioSalvaHistoria;
...
<div class="site-index">
    ...
    $salvas = UsuarioSalvaHistoria::find()->where(['usuario'=> $atual])->all();
    foreach ($salvas as $usuariosalvahistoria) {
        $hist = Historia::findOne($usuariosalvahistoria->historia);
        $numHistoria = $hist->id;
            ...
            <div class="col-md-12" id='<?= $numHistoria ?>'>
                <div class="box box-widget">
                    ...
                    <div class="box-body" style="display: block;">
                        ...
                        <button id='like<?= $numHistoria ?>' onclick="like(this)" type="button"
                    ...
                    <div class="box-footer">
                        ...
                        <div class="img-push">
                            <input id="cm<?= $numHistoria ?>" onkeydown="comentar(this)" type="text"
                                   class="form-control input-sm" placeholder="Escreva seu comentário...">
                        </div>
                        <!--  </form>-->
                    </div> <!-- /.box-footer -->
                </div>
